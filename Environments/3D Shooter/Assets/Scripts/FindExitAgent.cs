...
public class FindExitAgent : Agent
{
    ...
    public override void Heuristic(in ActionBuffers actionsOut)
    {
        ...
        {
            discreteActionsOut[0] = rightAction;
        }
        ...
        {
            discreteActionsOut[0] = leftAction;
        }
        ...
        {
            discreteActionsOut[0] = useAction;
        }
        else if (Input.GetKey(KeyCode.Mouse0))
        {
            discreteActionsOut[0] = attackAction;
        }
    }
